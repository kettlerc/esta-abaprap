		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ABAP RAP Freestyle",
									"targetURL": "#freestylerapabaprapfreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"freestylerapabaprapfreestyle-display": {
								"semanticObject": "freestylerapabaprapfreestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=freestylerap.abaprapfreestyle",
									"url": sap.ui.require.toUrl("freestylerap/abaprapfreestyle")
								}
							}
						}
					}
