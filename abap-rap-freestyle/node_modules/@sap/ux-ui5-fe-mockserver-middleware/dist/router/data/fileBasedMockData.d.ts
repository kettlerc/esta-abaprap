import { ComplexType, Property, EntityType, TypeDefinition } from '@sap-ux/annotation-converter';
...
export declare class FileBasedMockData {
     ...
     * @param defaultValue
     */
    protected getDefaultValueFromType(type: string, complexType: ComplexType | TypeDefinition, defaultValue?: any): any;
    /**
     * @param type
     * @param complexType
     * @param propertyName
     * @param lineIndex
     */
    protected getRandomValueFromType(type: string, complexType: ComplexType | TypeDefinition, propertyName: string, lineIndex: number): any;
    /**
     *
     */
